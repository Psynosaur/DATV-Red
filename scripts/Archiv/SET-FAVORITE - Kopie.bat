...
set /p ABITCHOICE=Please, choose your Audiobitrate 4k (1), 8k (2), 16k (3), 32k (4), 64 (5), 96k (6) :
...
:FREQUENCYRX
if "%DATVOUT%"=="yes" if NOT "%CHANGE%"=="2" more .\ini\frequency.ini
if "%DATVOUT%"=="yes" if NOT "%CHANGE%"=="2" set /p RXFREQCHOICE=Please, choose your RX-Frequency 0-28 :
if "%CHANGE%"=="2" more .\ini\frequency.ini
if "%CHANGE%"=="2" set /p RXFREQCHOICE=Please, choose your RX-Frequency 0-28 :

if /I "%RXFREQCHOICE%"=="0" if "%DATVOUT%"=="yes" if NOT "%CHANGE%"=="2" set /p RXFREQUENCY=Please, choose your RX-Frequency, input in kHz :
if /I "%RXFREQCHOICE%"=="0" if "%CHANGE%"=="2" set /p RXFREQUENCY=Please, choose your RX-Frequency, input in kHz :
...
if /I "%SRCHOICE%"=="0" set /p SR=Please, choose your SR (25-3000) :
...
:QPSKRX
if "%DATVOUT%"=="yes" if NOT "%CHANGE%"=="2" more .\ini\longmynd-sr.ini
if "%DATVOUT%"=="yes" if NOT "%CHANGE%"=="2" set /p SRCHOICE=Please, choose your RX-SR 0-9 :
if "%CHANGE%"=="2" more .\ini\longmynd-sr.ini
if "%CHANGE%"=="2" set /p SRCHOICE=Please, choose your RX-SR 0-9 :

if "%CHANGE%"=="2" if /I "%SRCHOICE%"=="0" set /p RXSR=Please, choose your RX-SR (25-4000) :
if "%CHANGE%"=="2" if /I "%SRCHOICE%"=="1" (SET RXSR=35)
if "%CHANGE%"=="2" if /I "%SRCHOICE%"=="2" (SET RXSR=66)
if "%CHANGE%"=="2" if /I "%SRCHOICE%"=="3" (SET RXSR=125)
if "%CHANGE%"=="2" if /I "%SRCHOICE%"=="4" (SET RXSR=250)
if "%CHANGE%"=="2" if /I "%SRCHOICE%"=="5" (SET RXSR=333)
if "%CHANGE%"=="2" if /I "%SRCHOICE%"=="6" (SET RXSR=500)
if "%CHANGE%"=="2" if /I "%SRCHOICE%"=="7" (SET RXSR=1000)
if "%CHANGE%"=="2" if /I "%SRCHOICE%"=="8" (SET RXSR=1500)
if "%CHANGE%"=="2" if /I "%SRCHOICE%"=="9" (SET RXSR=2000)
...
if /I "%SRCHOICE%"=="0" set /p SR=Please, choose your TX-SR (25-3000) :
...
REM Up to 3000K
if %SR% GTR 1500 if %SR% LSS 3001 set /a VBITRATE = (1000 * %TSBITRATE% * 89 / 100 / 1000) - %ABITRATE%
REM Above 3000K leads to invalid parameter check
if %SR% GTR 3000 set /a VBITRATE = (1000 * %TSBITRATE% * 90 / 100 / 1000) - %ABITRATE%
...
if %SR% GTR 3000 (echo Invalid SR ^>3000KS)&(GoTo CODEC)
if %VBITRATE% LSS 30 (echo Invalid parameters, Video-Bitrate below 30K)&(GoTo CODEC)
if %VBITRATE% LSS 50 if %FPS% GTR 16 (echo Invalid parameters, FPS too high)&(GoTo CODEC)
