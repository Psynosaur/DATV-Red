...
if "%MODE%"=="qpsk" set /p CONTROL=Which parameter to change, PTT off (0), PTT on (1), Frequency (2), Gain (3), Digital Gain (4), Advanced Options (5) :
if NOT "%MODE%"=="qpsk" set /p CONTROL=Which parameter to change, PTT off (0), PTT on (1), Frequency (2), Gain (3), Advanced Options (5) :
